...
if __name__ == "__main__":
    # Variables
    meta = get_meta('march_madness/__version__.py')
    name = meta['name']
    ...
    packages = find_packages(exclude=('tests', 'MarchMadnessSite', 'MarchMadnessSite/settings'))
    ...
    setup(name=name,
          ...
          install_requires=[
              'django_materialize_nav>=0.1.6',
              'django_reversion>=3.0.3',
              ],
          extras_require={
              },
